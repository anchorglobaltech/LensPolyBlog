    ...
    <div className="min-h-screen flex items-center justify-center w-full bg-gray-100">
      <div className="w-full max-w-7xl mx-auto px-6 md:px-12 lg:px-24 py-10 text-center">
        <div className="flex flex-col">
          <h1 className="text-5xl font-bold text-gray-800 my-7">About LensBlog</h1>
          
          <div className="text-lg text-gray-700 flex flex-col gap-6 text-justify leading-relaxed">
            <p>
              Welcome to <strong>LensBlog</strong>, a platform dedicated to insightful articles, 
            ...
            <p>
              LensBlog is designed to bring valuable content on various topics, including 
            ...
            <p>
              Additionally, this project is dedicated to the <strong>Library and Information Department</strong>,
              recognizing their contributions to knowledge dissemination and digital learning. 
              Their role in fostering information literacy and research is invaluable, and we appreciate 
              their commitment to education and technology.
            </p>

            <p>
              Join us on this journey of learning, discovery, and growth. 
              Your voice matters, and we encourage you to be a part of the <strong>LensBlog</strong> community!
            </p>
